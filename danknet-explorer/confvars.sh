...
# Pale Moon
MOZ_APP_BASENAME=danknet-explorer
...
MOZ_BRANDING_DIRECTORY=danknet-explorer/branding/unofficial
MOZ_OFFICIAL_BRANDING_DIRECTORY=danknet-explorer/branding/official
...
OMNIJAR_NAME=danknet-explorer.res
